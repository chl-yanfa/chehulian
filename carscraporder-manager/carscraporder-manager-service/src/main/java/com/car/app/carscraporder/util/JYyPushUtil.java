 ...
 * @date 2019/7/3 15:26
 */
public class JYyPushUtil {

    private static final String APP_KEY = "69c2b0dc5869a25c89318ff4";
    private static final String MASTER_SECRET = "cd12f8dad70aafc729baf313";
    private static final String MSG_CONTENT = "车互联运营";
    ...
    public static int sendToAll(String notification_title, String msg_title, String msg_content, String extrasparam) {
        int result = 0;
        try {
            PushPayload pushPayload= JYyPushUtil.buildPushObject_android_and_ios(notification_title,msg_title,msg_content,extrasparam);
            System.out.println(pushPayload+"宁润泽测试-1");
            PushResult pushResult=jpushClient.sendPush(pushPayload);
            System.out.println(pushResult+"宁润泽测试-2");
    ...
    public static int sendToRegistrationId( String registrationId,String notification_title, String msg_title, String msg_content, String extrasparam) {
        int result = 0;
        try {
            PushPayload pushPayload= JYyPushUtil.buildPushObject_all_registrationId_alertWithTitle(registrationId,notification_title,msg_title,msg_content,extrasparam);
        ...
        return PushPayload.newBuilder()
                ...
                .setNotification(Notification.newBuilder()
                        ...
                        .addPlatformNotification(AndroidNotification.newBuilder()
                                ...
                                .addExtra("AndroidlinkType",extrasparam)
                                .build())
                        //指定当前推送的iOS通知
                        .addPlatformNotification(IosNotification.newBuilder()
                                ...
                                .setSound("default")
                                //此字段为透传字段，不会显示在通知栏。用户可以通过此字段来做一些定制需求，如特定的key传要指定跳转的页面（value）
                                .addExtra("IoslinkType",extrasparam)
